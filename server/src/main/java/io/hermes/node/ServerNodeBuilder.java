...
import io.hermes.node.internal.InternalServerNode;
 ...
 *
 * <pre>
 * Node node = ServerNodeBuilder.nodeBuilder().node();
 * </pre>
 *
 * <p>
 ...
 *
 * <pre>
 * Node node = ServerNodeBuilder.nodeBuilder()
...
public class ServerNodeBuilder {
  ...
  /**
   * A convenient factory method to create a {@link ServerNodeBuilder}.
   */
  public static ServerNodeBuilder nodeBuilder() {
   ...
   */
  public ServerNodeBuilder settings(Settings.Builder settings) {
   ...
   * Explicit node settings to set.
   */
  public ServerNodeBuilder settings(Settings settings) {
   ...
   */
  public ServerNodeBuilder loadConfigSettings(boolean loadConfigSettings) {
   ...
   */
  public ServerNodeBuilder client(boolean client) {
   ...
   */
  public ServerNodeBuilder data(boolean data) {
   ...
   */
  public ServerNodeBuilder local(boolean local) {
   ...
   */
  public ServerNodeBuilder clusterName(String clusterName) {
   ...
   */
  public Node build() {
    return new InternalServerNode(settings.build(), loadConfigSettings);
  }
