...
import io.hermes.env.InternalSettingsPerparer;
 ...
 * @author spancer.ray
 */
public final class InternalServerNode implements Node {
  ...
  public InternalServerNode() throws HermesException {
   ...
   */
  public InternalServerNode(Settings pSettings, boolean loadConfigSettings) throws HermesException {
  ...
  public static void main(String[] args) throws Exception {
    final InternalServerNode node = new InternalServerNode();
    node.start();
